...
public class Camera : MonoBehaviour
{
    ...
    public float factor1 = 1f / 2f;

    public Transform bg2;
    public float factor2 = 1f / 4f;
    ...
    void LateUpdate() {
        ...
        bg1.position = new Vector3(bg1.position.x + (nextCamPosFrame - iniCamPosFrame) * factor1, bg1.position.y, bg2.position.z);
